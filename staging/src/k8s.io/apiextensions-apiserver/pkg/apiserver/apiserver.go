...
func (c completedConfig) New(delegationTarget genericapiserver.DelegationTarget) (*CustomResourceDefinitions, error) {
	// Register CRD validation metrics here rather than from an init() function so
	// that metric feature gates (e.g. NativeHistograms) have been applied before
	// the histogram metric is created.
	validation.RegisterMetrics()
