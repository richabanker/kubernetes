...
type DaemonSetInformerOptions struct {
	...
	// The full informer name will be InformerNamePrefix + "-daemonSet-informer",
...
func NewDaemonSetInformerWithOptions(client kubernetes.Interface, namespace string, options DaemonSetInformerOptions) cache.SharedIndexInformer {
	...
	if options.InformerNamePrefix != "" {
		...
		identifier, _ = cache.NewIdentifier(options.InformerNamePrefix+"-daemonSet-informer", gvr)
	}
...
func (f *daemonSetInformer) defaultInformer(client kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewDaemonSetInformerWithOptions(client, f.namespace, DaemonSetInformerOptions{ResyncPeriod: resyncPeriod, Indexers: cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, InformerNamePrefix: f.factory.InformerNamePrefix(), TweakListOptions: f.tweakListOptions})
}
