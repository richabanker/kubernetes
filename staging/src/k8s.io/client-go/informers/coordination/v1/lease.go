...
func NewLeaseInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewLeaseInformerWithOptions(client, namespace, resyncPeriod, indexers, LeaseInformerOptions{})
}

// NewLeaseInformerWithOptions constructs a new informer for Lease type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewLeaseInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options LeaseInformerOptions) cache.SharedIndexInformer {
	return NewFilteredLeaseInformerWithOptions(client, namespace, resyncPeriod, indexers, options)
}
...
func NewFilteredLeaseInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return NewFilteredLeaseInformerWithOptions(client, namespace, resyncPeriod, indexers, LeaseInformerOptions{TweakListOptions: tweakListOptions})
}

// NewFilteredLeaseInformerWithOptions constructs a new informer for Lease type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredLeaseInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options LeaseInformerOptions) cache.SharedIndexInformer {
