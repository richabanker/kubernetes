...
type LeaseInformerOptions struct {
	...
	// The full informer name will be InformerNamePrefix + "-lease-informer",
...
func NewLeaseInformerWithOptions(client kubernetes.Interface, namespace string, options LeaseInformerOptions) cache.SharedIndexInformer {
	...
	if options.InformerNamePrefix != "" {
		...
		identifier, _ = cache.NewIdentifier(options.InformerNamePrefix+"-lease-informer", gvr)
	}
...
func (f *leaseInformer) defaultInformer(client kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewLeaseInformerWithOptions(client, f.namespace, LeaseInformerOptions{ResyncPeriod: resyncPeriod, Indexers: cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, InformerNamePrefix: f.factory.InformerNamePrefix(), TweakListOptions: f.tweakListOptions})
}
