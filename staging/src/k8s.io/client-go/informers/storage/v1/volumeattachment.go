...
type VolumeAttachmentInformerOptions struct {
	...
	// The full informer name will be InformerNamePrefix + "-volumeAttachment-informer",
...
func NewVolumeAttachmentInformerWithOptions(client kubernetes.Interface, options VolumeAttachmentInformerOptions) cache.SharedIndexInformer {
	...
	if options.InformerNamePrefix != "" {
		...
		identifier, _ = cache.NewIdentifier(options.InformerNamePrefix+"-volumeAttachment-informer", gvr)
	}
...
func (f *volumeAttachmentInformer) defaultInformer(client kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewVolumeAttachmentInformerWithOptions(client, VolumeAttachmentInformerOptions{ResyncPeriod: resyncPeriod, Indexers: cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, InformerNamePrefix: f.factory.InformerNamePrefix(), TweakListOptions: f.tweakListOptions})
}
