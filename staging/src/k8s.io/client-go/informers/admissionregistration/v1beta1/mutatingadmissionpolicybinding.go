...
type MutatingAdmissionPolicyBindingInformerOptions struct {
	...
	// The full informer name will be InformerNamePrefix + "-mutatingAdmissionPolicyBinding-informer",
...
func NewMutatingAdmissionPolicyBindingInformerWithOptions(client kubernetes.Interface, options MutatingAdmissionPolicyBindingInformerOptions) cache.SharedIndexInformer {
	...
	if options.InformerNamePrefix != "" {
		...
		identifier, _ = cache.NewIdentifier(options.InformerNamePrefix+"-mutatingAdmissionPolicyBinding-informer", gvr)
	}
...
func (f *mutatingAdmissionPolicyBindingInformer) defaultInformer(client kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewMutatingAdmissionPolicyBindingInformerWithOptions(client, MutatingAdmissionPolicyBindingInformerOptions{ResyncPeriod: resyncPeriod, Indexers: cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, InformerNamePrefix: f.factory.InformerNamePrefix(), TweakListOptions: f.tweakListOptions})
}
