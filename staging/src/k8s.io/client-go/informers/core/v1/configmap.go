...
func NewConfigMapInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewConfigMapInformerWithOptions(client, namespace, resyncPeriod, indexers, ConfigMapInformerOptions{})
}

// NewConfigMapInformerWithOptions constructs a new informer for ConfigMap type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewConfigMapInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options ConfigMapInformerOptions) cache.SharedIndexInformer {
	return NewFilteredConfigMapInformerWithOptions(client, namespace, resyncPeriod, indexers, options)
}
...
func NewFilteredConfigMapInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return NewFilteredConfigMapInformerWithOptions(client, namespace, resyncPeriod, indexers, ConfigMapInformerOptions{TweakListOptions: tweakListOptions})
}

// NewFilteredConfigMapInformerWithOptions constructs a new informer for ConfigMap type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredConfigMapInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options ConfigMapInformerOptions) cache.SharedIndexInformer {
