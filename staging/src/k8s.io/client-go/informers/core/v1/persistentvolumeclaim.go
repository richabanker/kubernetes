...
// PersistentVolumeClaimInformerOptions holds the options for creating a PersistentVolumeClaim informer.
type PersistentVolumeClaimInformerOptions struct {
...
func NewPersistentVolumeClaimInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewPersistentVolumeClaimInformerWithOptions(client, namespace, resyncPeriod, indexers, PersistentVolumeClaimInformerOptions{})
}
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewPersistentVolumeClaimInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options PersistentVolumeClaimInformerOptions) cache.SharedIndexInformer {
	return NewFilteredPersistentVolumeClaimInformerWithOptions(client, namespace, resyncPeriod, indexers, options)
}
...
func NewFilteredPersistentVolumeClaimInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return NewFilteredPersistentVolumeClaimInformerWithOptions(client, namespace, resyncPeriod, indexers, PersistentVolumeClaimInformerOptions{TweakListOptions: tweakListOptions})
}

// NewFilteredPersistentVolumeClaimInformerWithOptions constructs a new informer for PersistentVolumeClaim type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredPersistentVolumeClaimInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options PersistentVolumeClaimInformerOptions) cache.SharedIndexInformer {
