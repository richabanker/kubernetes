...
func NewReplicationControllerInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewReplicationControllerInformerWithOptions(client, namespace, resyncPeriod, indexers, ReplicationControllerInformerOptions{})
}
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewReplicationControllerInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options ReplicationControllerInformerOptions) cache.SharedIndexInformer {
	return NewFilteredReplicationControllerInformerWithOptions(client, namespace, resyncPeriod, indexers, options)
}
...
func NewFilteredReplicationControllerInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return NewFilteredReplicationControllerInformerWithOptions(client, namespace, resyncPeriod, indexers, ReplicationControllerInformerOptions{TweakListOptions: tweakListOptions})
}

// NewFilteredReplicationControllerInformerWithOptions constructs a new informer for ReplicationController type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredReplicationControllerInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options ReplicationControllerInformerOptions) cache.SharedIndexInformer {
