...
// PodTemplateInformerOptions holds the options for creating a PodTemplate informer.
type PodTemplateInformerOptions struct {
...
func NewPodTemplateInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewPodTemplateInformerWithOptions(client, namespace, resyncPeriod, indexers, PodTemplateInformerOptions{})
}

// NewPodTemplateInformerWithOptions constructs a new informer for PodTemplate type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewPodTemplateInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options PodTemplateInformerOptions) cache.SharedIndexInformer {
	return NewFilteredPodTemplateInformerWithOptions(client, namespace, resyncPeriod, indexers, options)
}
...
func NewFilteredPodTemplateInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return NewFilteredPodTemplateInformerWithOptions(client, namespace, resyncPeriod, indexers, PodTemplateInformerOptions{TweakListOptions: tweakListOptions})
}

// NewFilteredPodTemplateInformerWithOptions constructs a new informer for PodTemplate type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredPodTemplateInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options PodTemplateInformerOptions) cache.SharedIndexInformer {
