...
func NewEndpointsInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewEndpointsInformerWithOptions(client, namespace, resyncPeriod, indexers, EndpointsInformerOptions{})
}

// NewEndpointsInformerWithOptions constructs a new informer for Endpoints type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewEndpointsInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options EndpointsInformerOptions) cache.SharedIndexInformer {
	return NewFilteredEndpointsInformerWithOptions(client, namespace, resyncPeriod, indexers, options)
}
...
func NewFilteredEndpointsInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return NewFilteredEndpointsInformerWithOptions(client, namespace, resyncPeriod, indexers, EndpointsInformerOptions{TweakListOptions: tweakListOptions})
}

// NewFilteredEndpointsInformerWithOptions constructs a new informer for Endpoints type with additional options.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredEndpointsInformerWithOptions(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, options EndpointsInformerOptions) cache.SharedIndexInformer {
