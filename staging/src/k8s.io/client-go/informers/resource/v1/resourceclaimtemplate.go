...
type ResourceClaimTemplateInformerOptions struct {
	...
	// The full informer name will be InformerNamePrefix + "-resourceClaimTemplate-informer",
...
func NewResourceClaimTemplateInformerWithOptions(client kubernetes.Interface, namespace string, options ResourceClaimTemplateInformerOptions) cache.SharedIndexInformer {
	...
	if options.InformerNamePrefix != "" {
		...
		identifier, _ = cache.NewIdentifier(options.InformerNamePrefix+"-resourceClaimTemplate-informer", gvr)
	}
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1().ResourceClaimTemplates(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ResourceV1().ResourceClaimTemplates(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ResourceV1().ResourceClaimTemplates(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ResourceV1().ResourceClaimTemplates(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *resourceClaimTemplateInformer) defaultInformer(client kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewResourceClaimTemplateInformerWithOptions(client, f.namespace, ResourceClaimTemplateInformerOptions{ResyncPeriod: resyncPeriod, Indexers: cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, InformerNamePrefix: f.factory.InformerNamePrefix(), TweakListOptions: f.tweakListOptions})
}
